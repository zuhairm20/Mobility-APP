...
// list adapter for find report items
public class reportListAdapter extends ArrayAdapter<ParseObject> {

    public reportListAdapter(Context context, int resource, List<ParseObject> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (p != null) {
            ...
            TextView userName = (TextView)  v.findViewById(R.id.reportUserName);
