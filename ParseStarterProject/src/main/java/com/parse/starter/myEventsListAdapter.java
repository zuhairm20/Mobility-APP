 ...
 */
public class myEventsListAdapter extends ArrayAdapter<ParseObject> {

        public myEventsListAdapter(Context context, int resource, List<ParseObject> items) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
                ...
                v = vi.inflate(R.layout.my_event_item_layout, null);
                }
